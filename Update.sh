...
wget http://connect.external.rae-corp.com/connect.zip.sha256 -O RAEConnectServer.zip.sha256.new
...
if cmp -s RAEConnectServer.zip.sha256 RAEConnectServer.zip.sha256.new; then
        ...
        wget http://connect.external.rae-corp.com/connect.zip -O RAEConnectServer.zip.new
